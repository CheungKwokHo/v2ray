_qr_create() {
	...
	local link="https://cheungkwokho.github.io/tools/qr.html#${vmess}"
	echo
...
_ss_qr() {
	local ss_link="ss://$(echo -n "${ssciphers}:${sspass}@${ip}:${ssport}" | base64 -w 0)#adamz.cc_ss_${ip}"
	local link="https://cheungkwokho.github.io/tools/qr.html#${ss_link}"
	echo
